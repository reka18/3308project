            ...
            <div class="search-results-card-layout-container"> <!-- row flex -->
                ...
                <div class="search-results-user-details-container">
                    <div>
                    	...
                    	<a href="#" id="followButton"><img class="search-results-follow-icon followMe search-results-follow-icon" onclick="followUser('${userName}')" src="images/follow-opt-w-512.png" alt=""/></a>
					</div>
